...
/** Palendrome - PalendromeMain.java
...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		...
		{
			JOptionPane.showMessageDialog(null, "This word IS a palendrome!");
		}
		else
		{
			JOptionPane.showMessageDialog(null, "The word is NOT a palendrome.");
		}
	...
	public static boolean isPal(Stack theStack)
	{
		...
		if(compStack.toString().equals(tempStack.toString()))
		{
			return true;
		}
		else
